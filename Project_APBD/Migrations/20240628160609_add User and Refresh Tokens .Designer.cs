...
namespace Project_APBD.Migrations
{
    ...
    [Migration("20240628160609_add User and Refresh Tokens ")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_APBD.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Project_APBD.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Project_APBD.Models.RefreshToken", b =>
                {
                    b.HasOne("Project_APBD.Models.User", "User")
                        .WithMany()
